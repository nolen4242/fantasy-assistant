...
- **BatterGameEV** (31,698) — barrels:INTEGER, bbe:INTEGER, date:DATE, ev_mean:FLOAT, game_pk:INTEGER, hardhit:INTEGER, source:STRING, uid:STRING
...
- **Recommendation** (23) — action_blob:STRING, created_at:DATE_TIME, kind:STRING, rationale:STRING, status:STRING, uid:STRING
...
- **Signal** (773) — agent:STRING, as_of:DATE, fa:BOOLEAN, kind:STRING, model_version:STRING, rationale:STRING, results_based:BOOLEAN, strength:FLOAT, uid:STRING
